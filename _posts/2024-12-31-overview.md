...
# Random
[Github Repo](https://github.com/salomaoalves/random) for projects from other data science fields, like Recommende System, Marketing Analytics and so on.
  - [Spotify](https://github.com/salomaoalves/random/tree/main/Spotify): Playing around with the Python library (Spotipy) that connects me to the Spotify API. Basically, I just wanted to look at the functions and see what's possible with them. There's a README.md file that explains what's in each folder/file.
